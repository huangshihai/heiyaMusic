...
public final class MusicConstant {
    ...
    public static final String QQMUSIC_URL = "http://dl.stream.qqmusic.qq.com/M500%s.mp3?vkey=%s&guid=1234567890&uin=1008611&fromtag=8";
    ...
    public static final String BAIDU_SEARCH = "http://musicapi.qianqian.com/v1/restserver/ting?query=%s&method=baidu.ting.search.common&format=json&page_no=%d&page_size=%d";

    public static final String BAIDU_INFO = "http://music.taihe.com/data/music/links";

    public static final String BAIDU_DETAIL = "http://tingapi.ting.baidu.com/v1/restserver/ting";
