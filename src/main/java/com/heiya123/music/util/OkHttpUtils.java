...
public class OkHttpUtils {
   ...
   */
  public static <T> T getRequest(String reqUrl, Map<String, String> headersParams,
      Map<String, String> params,
   ...
   * @param params 请求参数
   */
  public static String postRequest(String reqUrl, Map<String, String> headersParams,
      Map<String, String> params) {
    String rsp = null;
    try {
      okhttp3.Request.Builder RequestBuilder = new okhttp3.Request.Builder();
   ...
   * @param rspClass 实体类 执行命令获取指定结构 rspClass : 所需转出的结构，例：UserBean.class
   */
  public static <T> T postRequest(String reqUrl, Map<String, String> headersParams,
      Map<String, String> params,
      final Class<T> rspClass) {
    T t = null;
    try {
